...
| [ADR-002](002-local-first-runtime.md) | Accepted | Use a local-first runtime |
| [ADR-003](003-policy-outside-the-model.md) | Accepted | Enforce policy outside the model with OPA/Rego |
| [ADR-004](004-destructive-action-boundary.md) | Accepted | Keep destructive cloud actions behind approval boundaries |
...
| [ADR-007](007-low-cost-aws-deployment.md) | Accepted | Deploy a low-cost AWS environment after approval |
